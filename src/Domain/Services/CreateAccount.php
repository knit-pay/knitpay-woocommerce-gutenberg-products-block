...
class CreateAccount {
	...
	private static function is_feature_enabled() {
		$feature_gating = BlocksPackage::container()->get( FeatureGating::class );
		...
		return $feature_gating::is_feature_plugin_build() && defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '4.7', '>=' );
	}
